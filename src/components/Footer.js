    ...
    <div className="footer">
      <div className="footer-links">
        <Link
          ...
          title="Click to open LinkedIn page in a new tab"
        ...
        <Link
          className="footerlink"
          title="Click to open GitHub page in a new tab"
        ...
        <Link
          className="footerlink"
          title="Click to open Instagram page in a new tab"
        ...
        <Link
          className="footerlink"
          title="Click to open email client page in a new tab"
          to="mailto: scottisebrand@gmail.com"
          target="_blank"
          rel="noreferrer"
        >
          <svg
